...
def main():
    ...
    sigma_x_factor = st.sidebar.number_input(label="σ_x factor", min_value=0.001, step=0.0001, max_value=0.02, value=0.005, format="%.3f")
    sigma_y_factor = st.sidebar.number_input(label="σ_y factor", min_value=0.001, step=0.0001, max_value=0.02, value=0.005, format="%.3f")
    # — Grid size & seed —
